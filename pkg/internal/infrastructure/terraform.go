...
const (
	...
	// DefaultSubnetID is the computed subnet ID as generated by terraform
	DefaultSubnetID = "openstack_networking_subnet_v2.id"
)
...
func ComputeTerraformerTemplateValues(
	...
	if config.Networks.SubnetID != "" {
		createSubnet = false
		subnetConfig["subnetId"] = strconv.Quote(config.Networks.SubnetID)
	}
